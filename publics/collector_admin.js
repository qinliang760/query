...
goog.net.XhrManager.prototype.ajax$core$AjaxImpl$_js_ajax_request$arity$7 = function(a, b, c, d, e, f, g) {
  ...
  g = cljs.core.get.call(null, h, "\ufdd0:max-retries");
  var k = cljs.core.get.call(null, h, "\ufdd0:priority");
  cljs.core.get.call(null, h, "\ufdd0:timeout");
  h = cljs.core.get.call(null, h, "\ufdd0:id");
  return a.send(h, b, c, d, e, k, f, g)
};
...
ajax.core.json_response_format = function(a) {
  a = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  var b = cljs.core.get.call(null, a, "\ufdd0:keywords?"), c = cljs.core.get.call(null, a, "\ufdd0:prefix");
...
ajax.core.exception_response = function(a, b, c, d) {
  ...
  var e = cljs.core.get.call(null, c, "\ufdd0:description");
  c = cljs.core.PersistentArrayMap.fromArray(["\ufdd0:status", b, "\ufdd0:response", null], !0);
  a = [cljs.core.str(a.message), cljs.core.str("  Format should have been "), cljs.core.str(e)].join("");
  a = cljs.core.assoc.call(null, c, "\ufdd0:status-text", a, "\ufdd0:is-parse-error", !0, "\ufdd0:original-text", d.getResponseText());
  ...
  try {
    ...
    try {
      ...
      if(k instanceof Object) {
        return a = k, cljs.core.PersistentVector.fromArray([!1, ajax.core.exception_response.call(null, a, e, f, d)], !0)
      }
      throw k;
    }
  }catch(l) {
    if(l instanceof Object) {
      return a = l, cljs.core.PersistentVector.fromArray([!1, cljs.core.PersistentArrayMap.fromArray(["\ufdd0:status", 0, "\ufdd0:status-text", a.message, "\ufdd0:response", null], !0)], !0)
    }
    throw l;
  }
};
...
ajax.core.process_inputs = function(a, b, c, d) {
  ...
  d = cljs.core.get.call(null, e, "\ufdd0:headers");
  e = cljs.core.get.call(null, e, "\ufdd0:params");
...
ajax.core.ajax_request = function() {
  var a = null, b = function(b, c, f) {
    ...
    c = cljs.core.seq_QMARK_.call(null, c) ? cljs.core.apply.call(null, cljs.core.hash_map, c) : c;
    var h = cljs.core.get.call(null, c, "\ufdd0:format"), h = ajax.core.get_format.call(null, h);
...
ajax.core.transform_handler = function(a) {
  a = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  var b = cljs.core.get.call(null, a, "\ufdd0:error-handler"), c = cljs.core.get.call(null, a, "\ufdd0:handler");
  return function(a) {
    var e = cljs.core.nth.call(null, a, 0, null);
    a = cljs.core.nth.call(null, a, 1, null);
    e = cljs.core.truth_(e) ? c : b;
    return cljs.core.truth_(e) ? e.call(null, a) : null
  }
};
ajax.core.transform_format = function(a) {
  a = cljs.core.seq_QMARK_.call(null, a) ? cljs.core.apply.call(null, cljs.core.hash_map, a) : a;
  var b = cljs.core.get.call(null, a, "\ufdd0:response-format"), c = cljs.core.get.call(null, a, "\ufdd0:format"), b = ajax.core.keyword_response_format.call(null, b, a);
        ...
        if(l < k) {
          ...
          if(n) {
            ...
            if(cljs.core.chunked_seq_QMARK_.call(null, p)) {
              var q = cljs.core.chunk_first.call(null, p), r = cljs.core.chunk_rest.call(null, p), p = q, s = cljs.core.count.call(null, q), g = r, h = p, k = s
            }else {
